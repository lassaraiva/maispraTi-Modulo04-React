import QRCodeGenerator from "./QRCode/QRCodeGenarator"; // Importa o componente QRCodeGenerator
import IPAddressFinder from "./IP/IPAddressFinder"; // Importa o componente IPAddressFinder
import MovieSearchEngine from "./MovieSearch/MovieSearchEngine"; // Importa o componente MovieSearchEngine
import TodoApp from "./ToDo/TodoApp"; // Importa o componente TodoApp
import QuizApp from "./Quizz/QuizApp"; // Importa o componente QuizApp
import LanguageTranslator from "./Translator/LanguageTranslator"; // Importa o componente LanguageTranslator
